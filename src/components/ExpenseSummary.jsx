    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
      ...
      <div className="premium-notebook-card p-6 flex items-center justify-between">
        <div className="space-y-1">
          ...
          <h3 className="text-2xl font-black tracking-tight text-black">
            PKR {totalSpent.toLocaleString(undefined, { minimumFractionDigits: 0 })}
          </h3>
        </div>
      ...
      <div className="premium-notebook-card p-6 flex items-center justify-between">
        <div className="space-y-1">
          ...
          <h3 className="text-2xl font-black tracking-tight text-black">
            PKR {currentMonthSpent.toLocaleString(undefined, { minimumFractionDigits: 0 })}
          </h3>
        </div>
      ...
      <div className="premium-notebook-card p-6 flex items-center justify-between">
        <div className="space-y-1">
          ...
          <h3 className="text-2xl font-black tracking-tight text-black">
            {expenses.length} <span className="text-xs font-medium text-zinc-400 font-sans">Entries</span>
          </h3>
        </div>
